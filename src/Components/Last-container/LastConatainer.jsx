  ...
  return (
    <div className="last-container">
        ...
        <img src="https://png.pngtree.com/element_pic/00/16/08/1657b3267bb0f25.jpg" alt="" />
            ...
            <p>we provide complete business plan for you brand to acheive company target etc ... We</p>
        </div>
        <div className="small-con3">
        <img src="https://png.pngtree.com/element_pic/00/16/08/1657b3267bb0f25.jpg" alt="" />
        <h2>Business Planing</h2>
            <p>we provide complete business plan for you brand to acheive company target etc ... We</p>
        </div>
        <div className="small-con4">
        <img src="https://png.pngtree.com/element_pic/00/16/08/1657b3267bb0f25.jpg" alt="" />
        <h2>Business Planing</h2>
            <p>we provide complete business plan for you brand to acheive company target etc ... We</p>
        </div>
